...
// PWM LED
wire [31:0] wb_m2s_pwmLed_adr;
wire [31:0] wb_m2s_pwmLed_dat;
wire  [3:0] wb_m2s_pwmLed_sel;
wire        wb_m2s_pwmLed_we;
wire        wb_m2s_pwmLed_cyc;
wire        wb_m2s_pwmLed_stb;
wire  [2:0] wb_m2s_pwmLed_cti;
wire  [1:0] wb_m2s_pwmLed_bte;
wire [31:0] wb_s2m_pwmLed_dat;
wire        wb_s2m_pwmLed_ack;
wire        wb_s2m_pwmLed_err;
wire        wb_s2m_pwmLed_rty;
...
wb_intercon wb_intercon0
   (.wb_clk_i           (wb_clk),
    ...
    .wb_spi_flash_rdt_i (wb_s2m_spi_flash_dat),
    ...
    .wb_gpio2_rdt_i      (wb_s2m_gpio2_dat),
    .wb_gpio2_ack_i      (wb_s2m_gpio2_ack),
    .wb_gpio2_err_i      (wb_s2m_gpio2_err),
    .wb_gpio2_rty_i      (wb_s2m_gpio2_rty),
    // PWM_LED
    .wb_pwmLed_adr_o    (wb_m2s_pwmLed_adr),
    .wb_pwmLed_dat_o    (wb_m2s_pwmLed_dat),
    .wb_pwmLed_sel_o    (wb_m2s_pwmLed_sel),
    .wb_pwmLed_we_o     (wb_m2s_pwmLed_we),
    .wb_pwmLed_cyc_o    (wb_m2s_pwmLed_cyc),
    .wb_pwmLed_stb_o    (wb_m2s_pwmLed_stb),
    .wb_pwmLed_cti_o    (wb_m2s_pwmLed_cti),
    .wb_pwmLed_bte_o    (wb_m2s_pwmLed_bte),
    .wb_pwmLed_rdt_i    (wb_s2m_pwmLed_dat),
    .wb_pwmLed_ack_i    (wb_s2m_pwmLed_ack),
    .wb_pwmLed_err_i    (wb_s2m_pwmLed_err),
    .wb_pwmLed_rty_i    (wb_s2m_pwmLed_rty),
// PTC
...
// SPI
    ...
    .wb_spi_accel_rdt_i (wb_s2m_spi_accel_dat),
